class TurmasController < ApplicationController
  ...
  private
    ...
    def turma_params
      params.require(:turma).permit(:descricao, :vagas, :matriz_curricular_aplicada_id, :numero_efetivo_estudantes, :sala_recorrente, :turno_id, :ambiente_id, :created_by, :updated_by, :deleted_at)
    end
end
