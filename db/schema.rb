...
ActiveRecord::Schema[7.2].define(version: 2025_01_23_024541) do
  ...
  create_table "grades_curriculares", force: :cascade do |t|
    ...
    t.bigint "matriz_curricular_aplicada_id"
    t.bigint "user_id"
    t.string "created_by"
    t.string "updated_by"
    t.datetime "deleted_at"
  ...
  create_table "instituicoes", force: :cascade do |t|
    ...
    t.integer "horario_inicio_aula"
    t.integer "horario_fim_aulas"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "tipo_contrato_id"
    t.index ["email"], name: "index_users_on_email", unique: true
    t.index ["reset_password_token"], name: "index_users_on_reset_password_token", unique: true
    t.index ["tipo_contrato_id"], name: "index_users_on_tipo_contrato_id"
  end
  ...
  add_foreign_key "users", "tipos_contratos"
end
