...
function setLayout() {
  ...
  if (layout !== null && layout !== '') {
    ...
    if (layout === 'horizontal') {
      ...
      script.src = '/layout/able/assets/js/layout-horizontal.js'; // Load script for horizontal layout
      document.body.appendChild(script);
    } else if (layout === 'color-header') {
      // Change logo color for color-header layout
      if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
        document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', '/layout/able/assets/images/logo-white.svg');
      }
    } else if (layout === 'compact') {
      script.src = '/layout/able/assets/js/layout-compact.js'; // Load script for compact layout
      document.body.appendChild(script);
    } else if (layout === 'tab') {
      script.src = '/layout/able/assets/js/layout-tab.js'; // Load script for tab layout
      document.body.appendChild(script);
    }
  }
...
for (var t = 0; t < tc.length; t++) {
  tc[t].setAttribute('src', '/layout/able/assets/images/logo-white.svg');
}
