...
function layout_change(layout) {
  ...
  if (layout === 'dark') {
    ...
    updateLogo('.pc-sidebar .m-header .logo-lg', '/layout/able/assets/images/logo-white.svg');
    updateLogo('.navbar-brand .logo-lg', '/layout/able/assets/images/logo-white.svg');
    updateLogo('.auth-main.v1 .auth-sidefooter img', '/layout/able/assets/images/logo-white.svg');
    updateLogo('.footer-top .footer-logo', '/layout/able/assets/images/logo-white.svg');
    ...
    updateLogo('.pc-sidebar .m-header .logo-lg', '/layout/able/assets/images/logo-dark.svg');
    updateLogo('.navbar-brand .logo-lg', '/layout/able/assets/images/logo-dark.svg');
    updateLogo('.auth-main.v1 .auth-sidefooter img', '/layout/able/assets/images/logo-dark.svg');
    updateLogo('.footer-top .footer-logo', '/layout/able/assets/images/logo-dark.svg');
